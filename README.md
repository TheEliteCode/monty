# snake: Monty interpreter 
	...
	Welcome to the Monty Bytecode Interpreter. It was built using C lang and reads Monty bytecode files of any extension and interpretes the opcode it contains.
	It can be run as either a stack(LIFO) or queque (FIFO). Mode can be switched mid-script. The interpreter can handle a variety of monty opcodes, including printingg, mathematical operations, and more 
...
```
$ git clone https://github.com/TheEliteCode/monty.git
```
...
* Copied github READme.md  sample from **Brennan D Baraban**
